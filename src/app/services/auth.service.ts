...
export class AuthService {
  private baseUrl: string = 'https://localhost:7103/api/User/'; // connect to the Api
...
loginPost(loginObj: any)
  {
    return this.http.post<any>(`${this.baseUrl}authenticate`, loginObj);  // post to the  authenticate Api
